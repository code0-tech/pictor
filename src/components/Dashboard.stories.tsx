...
export const Dashboard = () => {
    ...
    const recent = [
        ...
        {name: "Data Retrieval Nexus", project: "Project Discovery", status: "success", duration: "4.2s", when: "3m ago"},
        {name: "Memory Archive Initiative", project: "Marketing Collateral", status: "success", duration: "2.3s", when: "6m ago"},
    ...
    const filterLabels = {all: "All projects", active: "Has active flows", attention: "Needs attention", healthy: "Healthy"} as const
    ...
    return <FullScreen bg={"var(--secondary)"}>
        <Layout p={0.5} showLayoutSplitter={false} layoutGap={16} leftContent={
            <Flex p={0.5} h={"100%"} style={{boxSizing: "border-box", flexDirection: 'column', gap: "0.7rem"}}>
            ...
            <Layout showLayoutSplitter={false} p={0.5} layoutGap={16} leftContent={
                <div style={{
                    height: "100%",
                    ...
                    <Flex h={"100%"} style={{boxSizing: "border-box", flexDirection: 'column', gap: "1.3rem"}}>
                        ...
                        <Flex style={{boxSizing: "border-box", flexDirection: 'column'}}>
                            ...
                            <Button variant={"none"} w={"100%"} justify={"flex-start"}
                                    paddingSize={"xxs"}>
                                <Avatar identifier={"Project Discovery"} size={16}/>
                                <Text size={"md"}>
                                    Project Discovery
                                </Text>
                            </Button>
                            <Button variant={"none"} w={"100%"} justify={"flex-start"}
                                    paddingSize={"xxs"}>
                                <Avatar identifier={"Exhouse GTM"} size={16}/>
                                <Text size={"md"}>
                                    Exhouse GTM
                                </Text>
                            </Button>
                            <Button variant={"none"} w={"100%"} justify={"flex-start"}
                                    paddingSize={"xxs"}>
                                <Avatar identifier={"Marketing Collateral"} size={16}/>
                                <Text size={"md"}>
                            ...
                            <Button variant={"none"} w={"100%"} justify={"flex-start"}
                                    paddingSize={"xxs"}>
                                <IconPlus color={"transparent"} size={16}/>
                                <Text size={"md"} hierarchy={"tertiary"}>
                                    Load all Projects
                                </Text>
                            </Button>
                            ...
                            <Menu>
                                <MenuTrigger asChild>
                                    <Button paddingSize={"xxs"} style={{borderRadius: "50rem"}} w={"100%"}
                                        ...
                                        <Avatar bg={"transparent"} identifier={"GLS organization"} size={32}/>
                    ...
                    <div style={{
                        ...
                        <Badge style={{
                            ...
                            <Breadcrumb>
                                <Flex align={"center"} style={{gap:"0.35rem"}}>
                                    <Avatar bg={"transparent"} identifier={"GLS organization"} size={24}/>
                                    <Text hierarchy={"tertiary"}>
                                        GLS workspace
                                    </Text>
                                </Flex>
                        ...
                        <ScrollArea style={{position: "absolute", inset: 0, zIndex: 1}}>
                            ...
                            <div style={{maxWidth: "52rem", margin: "0 auto", padding: "4rem 1rem"}}>
                                ...
                                {/* ── Slim, actionable attention banner — whole card is clickable ── */}
                                <Card color={"secondary"} className={"card--hover"} onClick={() => setFilter("attention")}>
                                    <Flex align={"center"} justify={"space-between"} style={{gap: "0.75rem"}}>
                                        <Flex align={"center"} style={{gap: "0.75rem", minWidth: 0}}>
                                            <div style={{width: 8, height: 8, borderRadius: "50%", background: "#FFBE0B", flexShrink: 0}}/>
                                ...
                                {/* ── Projects: collapsible full list with filter, sort & create ── */}
                                <Flex align={"center"} justify={"space-between"} style={{gap: "0.5rem"}}>
                                    <Button variant={"none"} paddingSize={"xxs"} onClick={() => setCollapsed((c) => !c)}>
                                ...
                                <Card color={"secondary"} paddingSize={"sm"}>
                                    <DataTable data={decoratedProjects} filter={dataFilter} sort={dataSort}
                                               pagination={!collapsed} limit={collapsed ? 4 : 8}>
                                        {(p) => <>
                                            <DataTableColumn>
                                                <Flex align={"center"} style={{gap: "0.75rem", minWidth: 0}}>
                                                    <Avatar identifier={p.name} size={30}/>
                                    ...
                                    {collapsed && matchCount > 4 && (
                                        <Flex justify={"center"} style={{borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "0.5rem"}}>
                                            <Button variant={"none"} paddingSize={"xxs"} onClick={() => setCollapsed(false)}>
                                                <Text size={"md"} hierarchy={"tertiary"}>
                                                    Show all {matchCount}
                                                </Text>
                                            </Button>
